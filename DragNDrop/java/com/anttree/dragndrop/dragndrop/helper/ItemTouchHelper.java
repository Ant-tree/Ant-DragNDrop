...
package com.anttree.dragndrop.dragndrop.helper;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * Re-use array to calculate dx dy for a RecyclerView.ViewHolder
     */
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = resources
                    .getDimension(R.dimen.ant_item_touch_helper_swipe_escape_velocity);
            mMaxSwipeVelocity = resources
                    .getDimension(R.dimen.ant_item_touch_helper_swipe_escape_max_velocity);
            setupCallbacks();
        }
    }
     ...
     *
     * @param selected    The RecyclerView.ViewHolder to drag or swipe. Can be null if you want to cancel the
     *                    current action
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if (swipeDir <= 0) {
                            ...
                            if (swipeDir > 0) {
                                ...
                                // We defer commonCallback to avoid editing adapter during a layout.
    ...
    /**
     * Starts dragging the provided RecyclerView.ViewHolder. By default, ItemTouchHelper starts a drag when a
     * View is long pressed. You can disable that behavior by overriding
     * {@link Callback#isLongPressDragEnabled()}.
     * <p>
     * For this method to work:
     * <ul>
     * <li>The provided RecyclerView.ViewHolder must be a child of the RecyclerView to which this
     * ItemTouchHelper
     * is attached.</li>
     ...
     * <p>
     *
     * @param viewHolder The RecyclerView.ViewHolder to start dragging. It must be a direct child of
     *                   RecyclerView.
    ...
    /**
     * Starts swiping the provided RecyclerView.ViewHolder. By default, ItemTouchHelper starts swiping a View
     ...
     * </pre>
     *
     * @param viewHolder The RecyclerView.ViewHolder to start swiping. It must be a direct child of
     *                   RecyclerView.
     */
    ...
    public interface ViewDropHandler {
         ...
         * <p>
         * A LayoutManager should implement this interface to init ready for the upcoming move
         * operation.
         * <p>
     ...
     * which touch behaviors are enabled per each RecyclerView.ViewHolder and also receive callbacks when user
     ...
     * Upon receiving this commonCallback, you should move the item from the old position
    ...
    public abstract static class Callback {
         ...
         * <pre>
         *     public void clearView(RecyclerView recyclerView, RecyclerView.RecyclerView.ViewHolder viewHolder){
         *         getDefaultUIUtil().clearView(((ItemTouchRecyclerView.ViewHolder) viewHolder).textView);
         *     }
         *     public void onSelectedChanged(RecyclerView.RecyclerView.ViewHolder viewHolder, int actionState) {
         *         if (viewHolder != null){
         *             getDefaultUIUtil().onSelected(((ItemTouchRecyclerView.ViewHolder) viewHolder).textView);
         *         }
         *     }
         ...
         *                 ((ItemTouchRecyclerView.ViewHolder) viewHolder).textView, dX, dY,
         ...
         *
         * @param actionState The action state you want to init flags in. Should be one of
         ...
         * @param viewHolder   The RecyclerView.ViewHolder for which the movement information is necessary.
        ...
        /**
         * Return true if the current RecyclerView.ViewHolder can be dropped over the the target RecyclerView.ViewHolder.
         * <p>
         ...
         * @param current      The RecyclerView.ViewHolder that user is dragging.
         * @param target       The RecyclerView.ViewHolder which is below the dragged RecyclerView.ViewHolder.
         * @return True if the dragged RecyclerView.ViewHolder can be replaced with the target RecyclerView.ViewHolder, false
         * otherwise.
         */
         ...
         * to the adapter position of {@code target} RecyclerView.ViewHolder
         ...
         * @param target       The RecyclerView.ViewHolder over which the currently active item is being
         *                     dragged.
         ...
         *
         * @param viewHolder The RecyclerView.ViewHolder that is being dragged.
        ...
        /**
         * Called by ItemTouchHelper to select a drop target from the list of RecyclerView.ViewHolders that
         ...
         *
         * @param selected    The RecyclerView.ViewHolder being dragged by the user.
         * @param dropTargets The list of RecyclerView.ViewHolder that are under the dragged View and
         *                    candidate as a drop.
         ...
         *                    are applied. This value does not include margins added by
         *                    {@link RecyclerView.ItemDecoration}s.
         * @return A RecyclerView.ViewHolder to whose position the dragged RecyclerView.ViewHolder should be
         * moved to.
         */
        ...
        /**
         * Called when a RecyclerView.ViewHolder is swiped by the user.
         * <p>
         ...
         * @param direction  The direction to which the RecyclerView.ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
        ...
        /**
         * Called when the RecyclerView.ViewHolder swiped or dragged by the ItemTouchHelper is changed.
         * <p/>
         * If you override this method, you should call super.
         *
         * @param viewHolder  The new RecyclerView.ViewHolder that is being swiped or dragged. Might be null if
         *                    it is cleared.
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(
                        R.dimen.ant_item_touch_helper_max_drag_scroll_per_frame);
            }
         ...
         * <p>
         * It is important to ensure the RecyclerView.ViewHolder will stay visible as otherwise, it might be
         * removed by the LayoutManager if the move causes the View to go out of bounds. In that
         * case, drag will end prematurely.
         *
         * @param recyclerView The RecyclerView controlled by the ItemTouchHelper.
         * @param viewHolder   The RecyclerView.ViewHolder under user's control.
         * @param fromPos      The previous adapter position of the dragged item (before it was
         *                     moved).
         * @param target       The RecyclerView.ViewHolder on which the currently active item has been dropped.
        ...
        /**
         * Called by ItemTouchHelper on RecyclerView's onDraw commonCallback.
         * <p>
         ...
         * @param recyclerView      The RecyclerView to which ItemTouchHelper is attached to
         * @param viewHolder        The RecyclerView.ViewHolder which is being interacted by the User or it was
        ...
        /**
         * Called by the ItemTouchHelper when user action finished on a RecyclerView.ViewHolder and now the View
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * defaults
         * and if you want to customize behavior per RecyclerView.ViewHolder, you can override
         ...
         *
         * @param defaultSwipeDirs Binary OR of directions in which the RecyclerView.ViewHolders can be swiped.
         */
         ...
         * certain directions depending on your use case.
         *
         * @param defaultDragDirs Binary OR of directions in which the RecyclerView.ViewHolders can be dragged.
         */
        ...
        /**
         * Returns the swipe directions for the provided RecyclerView.ViewHolder.
        ...
        /**
         * Returns the drag directions for the provided RecyclerView.ViewHolder.
    ...
    private static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        /**
         * We run updates on onDraw method but use the fraction from animator commonCallback.
